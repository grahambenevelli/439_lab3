...
OTHERSRCS = sender.cc receiver.cc unit.cc common.c sendAndRecv.cc receivePool.cc
...
receivePool: receivePool.o
	$(CC) -o receivePool receivePool.o common.o $(COMMONOBJS) $(LIBS)
